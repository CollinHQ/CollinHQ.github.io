  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-slate-300 text-lg md:text-xl max-w-lg leading-relaxed mb-10">
        Building spaces, streamlining operations, and keeping cross-functional
        teams aligned from blueprint to move-in.
      </p>
      <div className="flex flex-wrap gap-3 justify-center">
        {['SF & NYC', 'Office Build-Outs', 'Vendor Ops'].map((tag) => (
          <span
            key={tag}
