...
export default function ProjectCard({ project }) {
  ...
  return (
    <div
      className="group cursor-pointer h-full min-h-[18rem]"
    ...
    >
      {/* Hover-lift lives on its own wrapper so it never shares a transform with the
          perspective/flip element below — combining the two on one node makes the
          3D flip render mirrored in some browsers. */}
      <div className="w-full h-full transition-transform duration-300 group-hover:-translate-y-1.5">
