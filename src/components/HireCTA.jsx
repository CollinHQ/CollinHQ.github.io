    ...
    <section className="px-6 py-14">
      <div className="max-w-3xl mx-auto text-center border border-yellow-600/25 bg-yellow-500/5 rounded-2xl px-6 py-10">
        ...
        <h2 className="font-serif text-2xl md:text-3xl font-bold text-white mb-3">
          Hiring a Workplace Manager, Coordinator, or Office lead?
        </h2>
        <p className="text-slate-400 text-sm leading-relaxed mb-5 max-w-xl mx-auto">
          Open to Workplace Experience Manager, Workplace Manager, Workplace Coordinator,
          Office Manager, and Office Coordinator roles — plus facilities or move / build-out leads
          where the work is owning the space end to end.
        </p>
        {roles.length > 0 && (
